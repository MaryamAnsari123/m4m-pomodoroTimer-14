...
export default function PomodoroTimer() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br to-indigo-300 from-pink-300 dark:bg-gray-900">
      {/* Center the Pomodoro timer card within the screen */}
      <Card className="w-full max-w-md p-6 bg-[url('/img/p2.jpg')] bg-cover bg-center  shadow-lg rounded-lg">
        <div className="flex flex-col items-center justify-center gap-3">
          <h1 className="text-4xl font-bold text-center">Pomodoro Timer&#128340;</h1>
          <p className="text-base font-mono">A timer for the Pomodoro Technique.</p>
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="text-8xl font-bold text-cyan-600">
          ...
          <div className="flex items-center gap-6">
            ...
            <Button
              ...
              className="bg-blue-600 hover:bg-gray-700 hover:text-white text-yellow-400"
            >
          ...
          <div className="p-2 mt-7">
            ...
            <AlertDialog>
              <AlertDialogTrigger asChild>
                ...
                className="bg-blue-300 rounded-xl text-black font-bold hover:text-white hover:bg-gray-600">What is Pomodoro Technique?</Button>
              </AlertDialogTrigger>
